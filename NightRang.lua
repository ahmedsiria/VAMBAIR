...
Ids_Dev = {Id_Dev,bot_id,1373616147,1360140225,1481247035}
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or '≪━━━━━━VAMBAIR━━━━━━≫'
...
CmdStart = '\n❃∫ اهلا بك عزيزي ❃∫\n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "فامبير")..''..
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/VAMBAIR/master/NightRang.lua')
...
{{text = '💌 CH 💌', url="t.me/Xx_Sorce_Vambair_xX"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
