...
if res ~= 200 then
print('\27[0;31m≪━━━━━━𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬━━━━━━≫ ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "≪━━━━━━𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬━━━━━━≫ ≪━━━━━━𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬━━━━━━≫ ━"
exit 1
fi
if [ ! $token ]; then
echo "≪━━━━━━𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬━━━━━━≫ ≪━━━━━━𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬━━━━━━≫ ━ ━"
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬.")  
...
{{text = '𝔻𝔼𝕍 𝕍𝔸𝕄𝔹𝔸𝕀ℝ', url="t.me/V_a_a_m_b_a_I_r"}}, 
{{text = 'قناه السورس', url="t.me/Xx_SorceVambair_xX"}}, 
} 
...
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر 𝔻𝔼𝕍 𝕍𝔸𝕄𝔹𝔸𝕀ℝعام")
return false 
end
...
send(msg.chat_id_, msg.id_, " ⏎︙ لا يمكنك حظر 𝔻𝔼𝕍 𝕍𝔸𝕄𝔹𝔸𝕀ℝ\n")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1373616147) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع كتم 𝔻𝔼𝕍 𝕍𝔸𝕄𝔹𝔸𝕀ℝعام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1465250253) then  
...
if result.id_ == tonumber(1373616147) then
send(msg.chat_id_, msg.id_, " ⏎︙ لا يمكنك كتم 𝔻𝔼𝕍 𝕍𝔸𝕄𝔹𝔸𝕀ℝ\n")
return false 
end
if result.id_ == tonumber(1465250253) then
...
' }\n'..' ⏎︙  الايدي بالصوره » { '..idph..
' }\n'..' ⏎︙  الرفع » { '..setadd..
' }\n'..' ⏎︙  الحظر » { '..banm..' }\n\n≪━━━━━━𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬━━━━━━≫\n ⏎︙ قناة سورس فامبير ↓\n [🖨┇𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬.](t.me/Xx_SorceVambair_xX) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
{
{text = '☉ 𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸𝕀ℝ ☬ ☉', url="t.me/Xx_SorceVambair_xX"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '☉ 𝕊𝕆ŭℝℂ𝔼 𝕍𝔸𝕄𝔹𝔸??ℝ ☬ ☉', url="t.me/Xx_SorceVambair_xX"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
