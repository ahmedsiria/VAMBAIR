...
if res ~= 200 then
print('\27[0;31m≪━━━━━━✭VAMBAIR✭━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━✭VAMBAIR✭━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━✭VAMBAIR✭━━━━━━≫ ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/VAMBAIR/main/File_Bot/commands.lua") 
...
local UserName = (data.username_ or "Xx_SorceVambair_xX")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇✭VAMBAIR✭.")  
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/VAMBAIR/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ⏎︙ تم تحديث السورس \n ⏎︙ لديك اخر اصدار لسورس فامبير\n ⏎︙ الاصدار » {v2.5.9}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ✭' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⏎︙ اصدار سورس فامبير \n ⏎︙ الاصدار »{v2.5.9}')
end
...
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'Xx_SorceVambair_xX')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
usertext = '\n ⏎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Xx_SorceVambair_xX')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Xx_SorceVambair_xX')..') \n ⏎︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⏎︙ العضو : {["..data.first_name_.."](T.ME/Xx_SorceVambair_xX)}\n ⏎︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⏎︙ عذرا » {["..data.first_name_.."](T.ME/Xx_SorceVambair_xX)}\n ⏎︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = 'SOURCE VAMBAIR', url="t.me/Xx_SorceVambair_xX"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Xx_SorceVambair_xX')..') \n ⏎︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Xx_SorceVambair_xX')..') \n ⏎︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ⏎︙دا بـابـا فـامـبـيـر عـيـب")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1373616147) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع كتم المبرمج فامبير عام")
return false 
end
...
if Get_info then
local TextS = "\n ⏎︙ اهلا بك في متجر ملفات فامبير\n ⏎︙ ملفات السورس ↓\n≪━━━━━━✭VAMBAIR✭━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━✭VAMBAIR✭━━━━━━≫\n ⏎︙ علامة تعني { ✔️ } ملف مفعل\n ⏎︙ علامة تعني { ✖ } ملف معطل\n ⏎︙ قناة سورس فامبير ↓\n".." ⏎︙ [اضغط هنا لدخول](t.me/Xx_SorceVambair_xX) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ⏎︙ عذرا الملف لايدعم سورس فامبير \n") 
end
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","⏎︙ تم ترقيته مطور ثانوي فالبوت")  
end
...
local userid = text:match("^رفع مطور ثانوب (%d+)$")
database:sadd(bot_id.."Dev:SoFi:2", userid)
Reply_Status(msg,userid,"reply","⏎︙ تم ترقيته مطور ثانوي فالبوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","⏎︙ تم تنزيله من المطور ثانوي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","⏎︙ تم تنزيله من المطور ثانوي")  
else
send(msg.chat_id_, msg.id_,"⏎︙ لا يوجد حساب بهاذا المعرف")
end
end
...
if text == ("مسح المطورين الثناويين") and SudoBot(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⏎︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Xx_SorceVambair_xX')..')'
status  = '\n ⏎︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⏎︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⏎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Xx_SorceVambair_xX')..')'
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس فامبير ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس فامبير ؟ ", 
"كم مره حبيت؟ ", 
...
' }\n'..' ⏎︙  الايدي بالصوره » { '..idph..
' }\n'..' ⏎︙  الرفع » { '..setadd..
' }\n'..' ⏎︙  الحظر » { '..banm..' }\n\n≪━━━━━━✭VAMBAIR✭━━━━━━≫\n ⏎︙ قناة سورس فامبير ↓\n [🖨┇✭VAMBAIR✭.](t.me/Xx_SorceVambair_xX) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Xx_SorceVambair_xX')..')'..'\n ⏎︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فامبير').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فامبير')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
database:set(bot_id.."Xx_SorceVambair_xX:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Xx_SorceVambair_xX:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Xx_SorceVambair_xX:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Xx_SorceVambair_xX:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⏎︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Xx_SorceVambair_xX:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Xx_SorceVambair_xX:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فامبير يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فامبير').." غادر" or text == 'بوت غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'اسمي الكيوت فامبير🌚💕.')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Xx_SorceVambair_xX')..')'
local iduser = result.sender_user_id_
...
{
{text = '☉ ✭VAMBAIR✭ ☉', url="t.me/Xx_SorceVambair_xX"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@Xx_SorceVambair_xX','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فامبير')
